...
{
    public class Gestion_Usuarios : My_Window
    {
        ...
        public Gestion_Usuarios(Window contextParent, Data_Service dataService) : base("Gestion de Usuarios | AutoGest Pro", contextParent)
        {
