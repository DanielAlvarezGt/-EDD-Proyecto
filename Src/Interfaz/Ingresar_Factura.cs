...
{
    public class Ingresar_Factura : My_Window
    {
        private readonly Data_Service _DataService;
        private Entry _txtId;
        private Entry _txtTotal;
        
        public Ingresar_Factura(Window contextParent, Data_Service dataService) : base("Gestion de Usuarios | AutoGest Pro", contextParent)
        {
