...
{
    public class Visualizar_Repuestos : My_Window
    {
       ...
       // private Arbol_Avl arbolAvl;
          private Arbol_Avl arbolAvl = new Arbol_Avl();
        ...
        public Visualizar_Repuestos(Window contextParent, Data_Service dataService, Arbol_Avl? arbol = null) : base("Gestion de Usuarios | AutoGest Pro", contextParent)
        {
  ...
  _txtvRepuestos.Buffer.Text = "";
            ...
            if (_comboBox.ActiveText == "PreOrden")
            {
                ...
                var repuestos = _DataService.Arbol_Avl_Repuestos.preOrden();
                _txtvRepuestos.Buffer.Text = repuestos;
            }    
          else if (_comboBox.ActiveText == "InOrden")
    {
        // Mostrar los repuestos en preorden
        var repuestos = _DataService.Arbol_Avl_Repuestos.inOrden();
        _txtvRepuestos.Buffer.Text = repuestos;
    }
            else if (_comboBox.ActiveText == "PostOrden")
    {
        // Mostrar los repuestos en postorden
        var repuestos = _DataService.Arbol_Avl_Repuestos.postOrden();
        _txtvRepuestos.Buffer.Text = repuestos;
    }
        }
